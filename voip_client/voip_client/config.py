...
DEFAULT_RTP_PORT_RANGE = (10001, 20001)
...
AUDIO_FRAME_SIZE = 320  # Increased for better buffering
CODEC_PCMU = "PCMU"
CODEC_PCMA = "PCMA"
...
RTP_MAX_JITTER_BUFFER_MS = 500  # Increased maximum jitter buffer size in milliseconds
RTP_MIN_JITTER_BUFFER_MS = 50   # Increased minimum jitter buffer size in milliseconds